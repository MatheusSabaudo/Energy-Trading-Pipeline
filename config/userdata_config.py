...
# ============================================
BATTERY_PARAMS = {
    'include_battery': False,             # Enable/disable battery analysis
...
# ============================================
# 6. SEASONAL FACTORS (Q3 - Turin specific)
# ============================================
SEASONAL_FACTORS = {
    'January': 0.7,
    'February': 1.0,      # Baseline month
    'March': 1.4,
    'April': 1.8,
    'May': 2.1,
    'June': 2.3,
...
OUTPUT_CONFIG = {
    ...
    'plot_graphs': False,  # Set to True to enable visualizations
