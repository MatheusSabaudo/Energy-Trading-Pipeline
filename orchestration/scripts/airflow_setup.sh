...
try:
    ...
    print('OK (200) - dag_config imported successfully')
except Exception as e:
    print(f'ERROR: - dag_config import failed: {e}')
...
for dag_file in dag_files:
    ...
    if os.path.exists(filepath):
        print(f'OK (200) - {dag_file} exists')
    else:
        print(f'ERROR - {dag_file} missing')
"
