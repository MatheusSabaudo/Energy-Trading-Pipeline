...
@patch("ingestion.iot.solar_producer.random.uniform", side_effect=[0.85, 28.0])
@patch("ingestion.iot.solar_producer.datetime")
def test_generate_solar_event_uses_loss_config(mock_datetime, _mock_uniform):
    ...
    assert event["cloud_factor"] == 0.85
